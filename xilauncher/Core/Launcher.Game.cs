namespace xilauncher
{
    public partial class Launcher
    {
        ...
        private async Task<bool> LaunchGame(XiLoaderUserConfig config)
        {
            ...
            this.OnProcessChanged(EModules.Loader, ELauncherState.Starting);
        ...
        {
            if (await this.StopProcess(_procLoader, EModules.Loader))
                _procLoader = null;
        }
        ...
        private async void LoaderProcess_Exited(object? sender, EventArgs e)
        {
            if (sender == _procLoader)
            {
                ...
                await Task.Delay(16);
                this.OnProcessChanged(EModules.Loader, ELauncherState.Stopped);
            }
        }
